                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="name:required">Your specific address is required</div>
                            </div>
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="phone" type="tel" placeholder="(123) 456-7890" data-sb-validations="required" />
                                <label for="phone">Number of Cow</label>
                                <div class="invalid-feedback" data-sb-feedback="phone:required">Plese tell us how many cows do you have?.</div>
                            </div>
                            <!-- Message input-->
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="message" type="text" placeholder="Enter your message here..." style="height: 10rem" data-sb-validations="required"></textarea>
                                <label for="message">Describe Your Cowshed</label>
                                <div class="invalid-feedback" data-sb-feedback="message:required">Please discribe your cowshed.</div>
                            </div>
                            ...
                            <div class="d-none" id="submitSuccessMessage">
                                ...
                                <button class="btn btn-primary" href="index.php">Back</button>
                            </div>
